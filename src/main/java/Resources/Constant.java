...
public class Constant {
	...
	public static String CompanyName="Excel";
	public static String EmailID="kajal@gmail.com";
	public static String PhoneNo="0987654321";
	public static String JobTitle="Executive";
